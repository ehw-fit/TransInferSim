...
class RobertaLarge(TransformerModel):
    def __init__(self, name: str = "roberta_large", sequence_length: int = 256, num_layers: int = 24, embedding_dim: int = 1024, ffn_layer_dim: int = 4096, num_heads: int = 16, batch_size: int = 1, add_bias: bool = False, **kwargs):
